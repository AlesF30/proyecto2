...
$datoDocente=obtenerDatoDocentes($id_persona);

foreach ($datoDocente as $datos):
?>
<body>
    <section class="cont-formularioAlumno">
        <div class="formularioA">
            <form action="procesarModificarDocente.php" method="POST">
                <fieldset>
                    <legend>Editar datos del Docente</legend>
