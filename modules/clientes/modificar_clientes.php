...
$datosClientes=obtenerDatoCliente($id_persona);
...
<body>
    <section class="cont-formularioAlumno">
        <div class="formularioA">
            <form action="procesarModificarCliente.php" method="POST">
                <fieldset>
                    ...
                    <br>
                            ...
                            <label for="nombre de empresa">Nombre Empresa:</label>
                            <input type="text" name="nombre_empresa" value="<?php echo $datos ['nombre_empresa'];    ?>" /><br>
