...
<body>
    ...
    <section class="cont-formularioAlumno">
            <div class="formularioA">
                <form action="procesarProfesionales.php" method="POST">
                    <fieldset>
                        <legend>Datos personales del Profesional</legend>
                        ...
                        <br>
                                ...
                                <label for="profesionales_descipcion">Observacones:</label>
                                <input type="text" name="profesionales_descipcion" /><br>
